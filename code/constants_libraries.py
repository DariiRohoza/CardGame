...
MOVEMENT_TECH_LIB = {
    ...
    ("DASH-DOWN-LEFT", "DASH-DOWN-LEFT", "STALL", "JUMP"): "ULTRA",
    ("DASH-DOWN-RIGHT", "DASH-DOWN-RIGHT", "STALL", "JUMP"): "ULTRA",
    ("DASH-DOWN-LEFT", "DASH-DOWN-LEFT", "STALL", "STALL", "JUMP"): "ULTRA : EXTENDED",
    ("DASH-DOWN-RIGHT", "DASH-DOWN-RIGHT", "STALL", "STALL", "JUMP"): "ULTRA : EXTENDED",
    ...
    ("JUMP", "STALL", "DASH-NONE-LEFT", "STALL", "JUMP"): "B-HOP : HIGH-JUMP, EXTENDED",
    ("JUMP", "STALL", "DASH-NONE-RIGHT", "STALL", "JUMP"): "B-HOP : HIGH-JUMP, EXTENDED",
...
STACK_RANK_LIMIT = 7
PARRY_LONGEVITY = 4 # Includes the turn on which the parry is initiated
SUIT_PENALTY = -3
IDENTICAL_BOOST = 3
